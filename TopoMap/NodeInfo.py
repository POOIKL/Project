        ...
        if self.Start_flag == 0:
            ...
            if self.YoloTimeInterval >= self.SetYoloTime:
                self.TrashDict, self.IndicDict, self.TempImgDict, self.ImgNum, self.TempObjNum, self.ImgCount, self.FileNum, \
                    LMset, Obj, nowd, SendFlag = ml.CheckSaveOrPass(self.ImgCount, self.TrashDict, self.IndicDict, self.ImgNum, self.TempObjNum, self.TempImgDict, \
            ...
            for i in range(num):
                ...
                if OBJNameList == []:
                    ...
                    break
                TrashNum, IndicNum = ml.NumCount(OBJNameList)
                self.TrashDict, self.IndicDict = ml.UpdateDict([TrashNum, IndicNum], self.TrashDict, self.IndicDict)
                self.OBJNameListFlag = 1
